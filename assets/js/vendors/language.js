function changeLanguageFromDropdown(e){let n={English:"en",Deutsch:"de"}[e]||"en";"function"==typeof window.changeLanguage?window.changeLanguage(n):setTimeout(()=>{"function"==typeof window.changeLanguage?window.changeLanguage(n):updateLanguageIcon(document.getElementById("selectedLanguage").innerText=e)},100)}function updateLanguageIcon(e){var n=document.getElementById("languageIcon");if(n)switch(e){case"English":n.innerHTML=`
    <g clip-path="">
    ...
    </g>`;break;case"Deutsch":n.innerHTML=`
    ...
    </defs>`}}window.changeLanguageFromDropdown=changeLanguageFromDropdown;